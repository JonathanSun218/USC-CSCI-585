...
Diagram Explanation:
	...
	We assume that, for this specific design, each video only has one sponsor, but it is possible that videos can have multiple sponsors
	and sponsors can sponsor multiple videos.
